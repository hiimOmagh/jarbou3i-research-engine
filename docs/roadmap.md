...
- `v0.16.0-beta`: Portable Account Mock Flow.

## Current focus

`v0.16.0-beta` keeps portable-account/OAuth support mocked. It simulates account linking, token refresh, disconnect, and safe status export without real credentials or live provider calls.

## Next candidate

`v0.16.0-beta — Provider Mode Hardening + Browser QA`.
