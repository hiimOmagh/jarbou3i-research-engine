...
`v0.15.0-beta` keeps portable-account/OAuth support mocked. It simulates account linking, token refresh, disconnect, and safe status export without real credentials or live provider calls.
