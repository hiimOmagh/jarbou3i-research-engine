# Export Contract — v1.4.0-bio-alpha.1
...
```html
<meta name="app-version" content="1.4.0-bio-alpha.1">
<meta name="analysis-lens" content="strategic|biopolitical">
<main class="shell" data-analysis-lens="strategic|biopolitical" data-app-version="1.4.0-bio-alpha.1">
```
...
## v1.4.0-bio-alpha.1 scenario rationale coverage
...
## v1.4.0-bio-alpha.1 import and locale coverage
...
## v1.4.0-bio-alpha.1 CI/export lock
...
## v1.4.0-bio-alpha.1 hosted/public UI evidence
