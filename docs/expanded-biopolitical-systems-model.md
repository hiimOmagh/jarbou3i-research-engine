...
## v1.4.0-bio-alpha.7.2 — Prompt contract lock
...
## v1.4.0-bio-alpha.7.2 — Systems completeness diagnostics
...
## v1.4.0-bio-alpha.7.2 export replay evidence
