# Hosted Demo Evidence — v1.4.0-bio-alpha.1
...
- the app version metadata matches `1.4.0-bio-alpha.1`;
...
From v1.4.0-bio-alpha.1 onward, generated evidence should be reviewed before release lock:
