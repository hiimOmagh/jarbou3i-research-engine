# Local CI Split — v1.4.0-bio-alpha.10.1
...
## v1.4.0-bio-alpha.10.1 hosted evidence archive step
...
3. Generate and validate `hosted-demo-evidence-v1.4.0-bio-alpha.10.1.zip` with `tests/hosted-demo-evidence-archive-check.mjs`.
...
## v1.4.0-bio-alpha.10.1 browser worker stability note
...
## v1.4.0-bio-alpha.10.1 archive structure guard

The hosted evidence archive identity check also validates archive structure. Remove patch ZIPs and stale hosted evidence archives before browser validation; the generated archive must be named `hosted-demo-evidence-v1.4.0-bio-alpha.10.1.zip` and must contain exactly the required evidence files, without nested ZIP files.

## v1.4.0-bio-alpha.10.1 release-candidate report cleanup
