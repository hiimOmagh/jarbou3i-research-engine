...
if (schema.properties?.workflow_version?.const !== '0.5.0-alpha') fail('workflow_version const mismatch');
...
if (fixture.workflow_version !== '0.5.0-alpha') fail('fixture workflow version mismatch');
if (!plan || plan.plan_version !== '0.5.0-alpha') fail('fixture missing alpha research plan');
...
if (!fixture.analysis_brief || fixture.analysis_brief.brief_version !== '0.5.0-alpha') fail('fixture needs compiled analysis brief');
...
if (!fixture.diagnostics || fixture.diagnostics.diagnostics_version !== '0.5.0-alpha') fail('fixture needs diagnostics');
...
if (!fixture.ai_runs.every((run) => run.run_version === '0.5.0-alpha' && run.provider && run.task && run.response_contract && run.provider_safety)) fail('fixture provider runs need contracts and safety metadata');
