...
for (const id of ['researchLabPanel','generatePlanBtn','copyPlanPromptBtn','evClaim','addEvidenceBtn','generateMockAnalysisBtn','runMockRepairBtn','runCritiqueBtn','researchQualityOutput']) {
...
if (schema.properties?.workflow_version?.const !== '0.1.0-alpha') fail('workflow_version const mismatch');
...
if (fixture.workflow_version !== '0.1.0-alpha') fail('fixture workflow version mismatch');
if (!plan || plan.plan_version !== '0.1.0-alpha') fail('fixture missing alpha research plan');
