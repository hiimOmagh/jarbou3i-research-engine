...
if (schema.properties?.workflow_version?.const !== '0.15.0-beta') fail('workflow_version const mismatch');
...
if (fixture.workflow_version !== '0.15.0-beta') fail('fixture workflow version mismatch');
if (!plan || plan.plan_version !== '0.15.0-beta') fail('fixture missing alpha research plan');
...
if (!fixture.analysis_brief || fixture.analysis_brief.brief_version !== '0.15.0-beta') fail('fixture needs compiled analysis brief');
...
if (!fixture.diagnostics || fixture.diagnostics.diagnostics_version !== '0.15.0-beta') fail('fixture needs diagnostics');
...
if (!fixture.ai_runs.every((run) => run.run_version === '0.15.0-beta' && run.provider && run.task && run.response_contract && run.response_validation && run.repair_trace && run.provider_safety && run.provider_identity && run.provider_billing_policy)) fail('fixture provider runs need contracts, identity, billing, and safety metadata');
