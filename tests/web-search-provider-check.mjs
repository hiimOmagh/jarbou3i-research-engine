...
assert.equal(schema.properties.workflow_version.const, '0.28.0-beta');
...
const identity = abstraction.searchProviderIdentity('brave_search_api', { version:'0.28.0-beta' });
...
const budget = abstraction.buildSearchQueryBudget({ version:'0.28.0-beta', max_queries:99, max_results_per_query:99, counter_evidence_queries:4 });
...
const diagnostics = connectors.sourceDiagnostics({ evidence_matrix:[], workflow_version:'0.28.0-beta' }, req, response);
