...
if (!body.ok || body.proxy_version !== '0.22.0-beta') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '0.22.0-beta') fail('provider task response version mismatch');
