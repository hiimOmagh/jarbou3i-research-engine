...
assert.equal(exportPack.EXPORT_PACK_VERSION, '0.28.0-beta');
...
assert.equal(fixture.workflow_version, '0.28.0-beta');
assert.equal(fixture.export_pack.export_pack_version, '0.28.0-beta');
...
const pack = exportPack.createExportPack(hostile, { version: '0.28.0-beta' });
assert.equal(pack.export_pack_version, '0.28.0-beta');
...
assert.equal(privacyFile.export_pack_version, '0.28.0-beta');
...
assert.equal(migrated.packet.workflow_version, '0.28.0-beta');
assert.equal(migrated.packet.export_pack.export_pack_version, '0.28.0-beta');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '0.28.0-beta');
