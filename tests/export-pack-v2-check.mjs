...
assert.equal(exportPack.EXPORT_PACK_VERSION, '0.29.0-rc.1');
...
assert.equal(fixture.workflow_version, '0.29.0-rc.1');
assert.equal(fixture.export_pack.export_pack_version, '0.29.0-rc.1');
...
const pack = exportPack.createExportPack(hostile, { version: '0.29.0-rc.1' });
assert.equal(pack.export_pack_version, '0.29.0-rc.1');
...
assert.equal(privacyFile.export_pack_version, '0.29.0-rc.1');
...
assert.equal(migrated.packet.workflow_version, '0.29.0-rc.1');
assert.equal(migrated.packet.export_pack.export_pack_version, '0.29.0-rc.1');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '0.29.0-rc.1');
