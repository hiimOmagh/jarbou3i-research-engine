...
if (schema.properties.workflow_version.const !== '0.12.0-beta') fail('schema workflow version mismatch');
...
if (fixture.workflow_version !== '0.12.0-beta') fail('fixture version mismatch');
