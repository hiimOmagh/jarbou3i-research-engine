...
if (pkg.version !== '1.0.4') fail('package version must be 1.0.4');
if (!index.includes('name="app-version" content="1.0.4"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.0.4') fail('research workflow schema version mismatch');
