...
if (fixture.workflow_version !== '1.0.6') fail('fixture version mismatch');
...
if (!fixture.evidence_review_report || fixture.evidence_review_report.review_version !== '1.0.6') fail('fixture review report missing');
