...
if (fixture.workflow_version !== '0.29.0-rc.1') fail('fixture version mismatch');
...
if (!fixture.evidence_review_report || fixture.evidence_review_report.review_version !== '0.29.0-rc.1') fail('fixture review report missing');
