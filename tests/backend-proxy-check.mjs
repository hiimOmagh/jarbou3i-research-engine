...
for (const token of ['GET  /api/health', 'POST /api/provider-task', 'npm run test:backend:worker', 'payload_secret_fields_stripped']) {
...
for (const token of ['missing_OPENAI_API_KEY_secret', 'invalid_task', 'prompt_too_large', 'SHOULD_NOT_LEAVE_BROWSER', 'api_key_exposed', 'mock-upstream']) {
