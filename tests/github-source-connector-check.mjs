...
const req = connectors.buildSourceTaskRequest({ version:'0.26.0-beta', connector:'github_public_repo', github_repo:'octocat/Hello-World', topic:'GitHub source test', task:'source_plan' });
...
assert.equal(body.proxy_version, '0.26.0-beta');
