...
const req = connectors.buildSourceTaskRequest({ version:'0.29.0-rc.1', connector:'github_public_repo', github_repo:'octocat/Hello-World', topic:'GitHub source test', task:'source_plan' });
