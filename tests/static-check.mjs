...
if (pkg.version !== '1.4.0-bio-alpha.7.1') fail('package version must be 1.4.0-bio-alpha.7.1');
if (!index.includes('name="app-version" content="1.4.0-bio-alpha.7.1"')) fail('app version metadata missing');
