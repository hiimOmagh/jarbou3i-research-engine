...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '0.22.0-beta');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '0.22.0-beta' });
assert.equal(result.privacy_export.audit_version, '0.22.0-beta');
