...
if (packageJson.version !== '1.4.0-bio-alpha.10.1') {
  fail('root package version must be 1.4.0-bio-alpha.10.1');
}

for (const script of ['test:ci:no-browser', 'test:ci:browser', 'test:ci', 'test:hygiene', 'test:release:readiness']) {
