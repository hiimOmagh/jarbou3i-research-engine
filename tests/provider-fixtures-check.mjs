...
for (const file of files) {
  ...
  const validation = core.validateProviderResponse(payload(fixture.task), response, { version: '0.21.0-beta', nowIso: () => '2026-04-28T00:00:00.000Z' });
...
if (report.suite_version !== '0.21.0-beta') fail('fixture suite version mismatch');
