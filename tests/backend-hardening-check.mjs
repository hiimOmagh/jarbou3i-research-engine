...
assert.equal(pkg.version, '0.26.0-beta');
...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '0.26.0-beta');
assert.equal(fixture.backend_hardening.hardening_version, '0.26.0-beta');
