...
## v1.4.0-bio-alpha.10.1 prompt contract and sample gate
...
## v1.4.0-bio-alpha.10.1 smoke stability note
...
## v1.4.0-bio-alpha.10.1 diagnostics export and replay fixture
...
## v1.4.0-bio-alpha.10.1 hosted evidence archive identity guard

Hosted evidence now produces a versioned archive named `hosted-demo-evidence-v1.4.0-bio-alpha.10.1.zip` after the screenshot and visible-text evidence directory passes review. The archive identity guard rejects stale or unversioned hosted evidence archives, validates `hosted-demo-metadata.json`, confirms every visible-text snapshot matches the runtime `meta[name="app-version"]`, and verifies the archive filename matches the current app version.
...
## v1.4.0-bio-alpha.10.1 browser-core stability guard
...
## v1.4.0-bio-alpha.10.1 release-candidate readiness
