...
- `fixtures/privacy/browser-generated-export-v0.28.json`
- `docs/v0.28.0-beta-real-source-connector-prototype.md`
...
- `docs/v0.28.0-beta-advanced-quality-gate-v3.md`
...
Full v0.28 no-browser release check:
