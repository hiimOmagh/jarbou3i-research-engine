...
This directory contains the optional Cloudflare Worker proxy for Jarbou3i Research Engine v0.28.0-beta.
...
The v0.28 source endpoint supports a narrow real connector:
