## v1.0.1 — Public Beta / Stable Research Engine

- Promoted v0.29.0-rc.1 to v1.0.1 after external CI/browser validation was reported successful.
- Added stable release metadata and stable release QA check.
- Added v0.29.0-rc.1 → v1.0.1 migration fixture/support.
- Preserved privacy/export/migration/source/backend/OAuth guardrails.
- No new feature surface was added in this promotion.

# Changelog

## v1.0.1 — Real Backend Provider Hardening
...
## v1.0.1 — Advanced Quality Gate v3
...
## v1.0.1 — Real Source Connector Prototype
...
## v1.0.1 — Web Search Provider Abstraction
...
## v1.0.1 — Real Portable OAuth Spike
...
## v1.0.1 — Release Candidate Freeze
...
- Added v0.28 → v1.0.1 migration fixture.
...
- Updated CI no-browser syntax gate to target `tests/v101-no-browser-suite.mjs` instead of the obsolete RC wrapper.
- Added `tests/patch-stabilization-check.mjs`.
- Added `tests/v101-no-browser-suite.mjs`.
- Added `fixtures/migrations/v1.0.0-packet.json` for v1.0.0 → v1.0.1 compatibility.
- Added `fixtures/privacy/browser-generated-export-v1.0.1.json`.
