## v1.4.0-bio-alpha.10.1 — Remote Artifact Finalization + Release Candidate Readiness Gate

- Adds `tests/release-candidate-readiness-check.mjs` as the final browser-side release-candidate gate.
- Writes `release-candidate-lock-report-v1.4.0-bio-alpha.10.1.json` and `.md` after hosted evidence review and archive validation.
...
## v1.4.0-bio-alpha.10.1 — Evidence Archive Structure Guard + Remote Lock Finalization
...
## v1.4.0-bio-alpha.10.1 — Remote No-Browser Hygiene CI Hotfix
...
## v1.4.0-bio-alpha.10.1 — Browser Core Worker Contract Hotfix
...
## v1.4.0-bio-alpha.10.1 — Browser Core Worker Stability Hotfix
...
- Adds `tests/hosted-demo-evidence-archive-check.mjs` to generate and validate `hosted-demo-evidence-v1.4.0-bio-alpha.10.1.zip` after hosted evidence review.
...
- Requires archive metadata, visible-text snapshots, and runtime app version to agree with `1.4.0-bio-alpha.10.1`.
