...
- Added local-only first-run onboarding guide.
- Added first-run checklist and progress state for topic, plan, evidence, review queue, quality, and export.
- Added export-safe onboarding metadata to research packets, schema, fixtures, migration defaults, and privacy snapshots.
- Added `src/research/onboarding.js`, `tests/onboarding-first-run-check.mjs`, and `tests/v105-no-browser-suite.mjs`.
- Preserved manual/private default, collapsed advanced internals, provider/OAuth/backend/source boundaries, privacy gates, and browser QA hardening.

## v1.0.5 — Public Beta / Stable Research Engine

- Promoted v0.29.0-rc.1 to v1.0.5 after external CI/browser validation was reported successful.
- Added stable release metadata and stable release QA check.
- Added v0.29.0-rc.1 → v1.0.5 migration fixture/support.
- Preserved privacy/export/migration/source/backend/OAuth guardrails.
- No new feature surface was added in this promotion.

# Changelog

## v1.0.5 — Real Backend Provider Hardening
...
## v1.0.5 — Release Candidate Freeze
...
- Added v0.28 → v1.0.5 migration fixture.
...
- Added `fixtures/migrations/v1.0.0-packet.json` for v1.0.0 → v1.0.5 compatibility.
- Added `fixtures/privacy/browser-generated-export-v1.0.5.json`.
...
- Added `fixtures/migrations/v1.0.1-packet.json` and `fixtures/privacy/browser-generated-export-v1.0.5.json`.
...
- Added explicit show/hide toggles for duplicate command surfaces.
- Added compact next-action guidance to the Release Health summary.
- Compressed empty states and reduced blank-space perception.
...
- Added v1.0.3 → v1.0.5 migration fixture.
