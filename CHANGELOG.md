...
- Promoted v0.29.0-rc.1 to v1.0.2 after external CI/browser validation was reported successful.
- Added stable release metadata and stable release QA check.
- Added v0.29.0-rc.1 → v1.0.2 migration fixture/support.
- Preserved privacy/export/migration/source/backend/OAuth guardrails.
- No new feature surface was added in this promotion.

# Changelog

## v1.0.2 — Real Backend Provider Hardening
...
## v1.0.2 — Real Source Connector Prototype
...
## v1.0.2 — Release Candidate Freeze
...
- Added v0.28 → v1.0.2 migration fixture.
...
- Added `fixtures/migrations/v1.0.0-packet.json` for v1.0.0 → v1.0.2 compatibility.
- Added `fixtures/privacy/browser-generated-export-v1.0.2.json`.
...
- Added `fixtures/migrations/v1.0.1-packet.json` and `fixtures/privacy/browser-generated-export-v1.0.2.json`.
