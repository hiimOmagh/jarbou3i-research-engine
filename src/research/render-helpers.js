/* Jarbou3i Research Engine render helpers v1.0.5. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.5 · Onboarding + First-Run Success',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.5 · إصدار عام تجريبي / محرك بحث مستقر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.5 · Bêta publique / moteur stable',
