/* Jarbou3i Research Engine render helpers v1.0.2. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.2 · Public Beta / Stable Research Engine',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.2 · إصدار عام تجريبي / محرك بحث مستقر' ,
    ...
    fr: {
      ...
      alphaBadge:'v1.0.2 · Bêta publique / moteur stable',
