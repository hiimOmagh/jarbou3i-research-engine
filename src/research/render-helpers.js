/* Jarbou3i Research Engine render helpers v0.18.0-beta. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v0.18.0-beta · module split',
    ...
    ar: {
      ...
      alphaBadge:'v0.18.0-beta · تقسيم الوحدات' ,
    ...
    fr: {
      ...
      alphaBadge:'v0.18.0-beta · séparation modulaire',
