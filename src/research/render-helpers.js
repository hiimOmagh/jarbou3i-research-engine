/* Jarbou3i Research Engine render helpers v0.24.0-beta. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v0.24.0-beta · Export Pack v2',
    ...
    ar: {
      ...
      alphaBadge:'v0.24.0-beta · حزمة التصدير v2' ,
    ...
    fr: {
      ...
      alphaBadge:'v0.24.0-beta · Pack d’export v2',
