/* Jarbou3i Research Engine render helpers v1.0.6. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.6 · Documentation + Release Packaging Cleanup',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.6 · تنظيف التوثيق وحزمة الإصدار' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.6 · Nettoyage documentation et paquet de publication',
