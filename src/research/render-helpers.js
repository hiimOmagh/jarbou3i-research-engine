/* Jarbou3i Research Engine render helpers v0.19.0-beta. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v0.19.0-beta · privacy audit',
    ...
    ar: {
      ...
      alphaBadge:'v0.19.0-beta · تدقيق الخصوصية' ,
    ...
    fr: {
      ...
      alphaBadge:'v0.19.0-beta · audit confidentialité',
