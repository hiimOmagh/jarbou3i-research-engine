/* Jarbou3i Research Engine render helpers v0.26.0-beta. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v0.26.0-beta · Backend Hardening',
    ...
    ar: {
      ...
      alphaBadge:'v0.26.0-beta · تقوية الخادم الخلفي' ,
    ...
    fr: {
      ...
      alphaBadge:'v0.26.0-beta · Backend renforcé',
