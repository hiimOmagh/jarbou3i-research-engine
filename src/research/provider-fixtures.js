/* Jarbou3i Research Engine provider fixtures v0.8.0-alpha. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      ...
      packet:{workflow_version:'0.8.0-alpha'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'0.8.0-alpha', nowIso:()=>'2026-04-28T00:00:00.000Z'});
