/* Jarbou3i Research Engine provider fixtures v0.29.0-rc.1. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      ...
      packet:{workflow_version:'0.29.0-rc.1'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'0.29.0-rc.1', nowIso:()=>'2026-04-28T00:00:00.000Z'});
