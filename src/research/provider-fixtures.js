/* Jarbou3i Research Engine provider fixtures v0.21.0-beta. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      ...
      packet:{workflow_version:'0.21.0-beta'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'0.21.0-beta', nowIso:()=>'2026-04-28T00:00:00.000Z'});
