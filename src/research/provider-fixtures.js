/* Jarbou3i Research Engine provider fixtures v1.0.6. */
(function(global){
  'use strict';
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'1.0.6', nowIso:()=>'2026-04-28T00:00:00.000Z'});
