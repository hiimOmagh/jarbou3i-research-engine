/* Jarbou3i Research Engine migrations v0.29.0-rc.1. */
(function(global){
  'use strict';
  const root = global.Jarbou3iResearchModules = global.Jarbou3iResearchModules || {};
  const MIGRATION_VERSION = '0.29.0-rc.1';
  const TARGET_VERSION = '0.29.0-rc.1';
  const SUPPORTED_SOURCES = Object.freeze(['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta','0.25.0-beta','0.26.0-beta','0.27.0-beta','0.28.0-beta','0.29.0-rc.1']);
  ...
  function detectSourceVersion(raw){
    ...
    for(const candidate of candidates){
      ...
      const match = normalized.match(/0\.(1[1-9]|2[0-8])\.0-beta/);
  ...
  function migrationPath(sourceVersion, targetVersion){
    ...
    const order = ['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta','0.25.0-beta','0.26.0-beta','0.27.0-beta','0.29.0-rc.1'];
  ...
  function defaultReleaseCandidate(){
    return {release_candidate_version:TARGET_VERSION, policy:{release_version:TARGET_VERSION, release_stage:'rc', rc_number:1, freeze_status:'feature_freeze', feature_freeze:true, breaking_changes_allowed:false, production_oauth_allowed:false, new_live_connectors_allowed:false, export_privacy_regression_allowed:false, allowed_work:['bugfix','docs','qa','a11y','privacy_audit','migration_compatibility','release_packaging'], blocked_work:['new_major_feature','new_live_provider','new_source_connector','oauth_production_enablement','schema_break_without_migration','secret_export_weakening'], required_gates:['test:qa:core','test:privacy','test:provider','test:source','test:backend','test:export-pack','test:quality','test:migrations','test:browser:provider'], gate_policy:'all_required_gates_must_pass_before_v1', verdict:'release_candidate_freeze_active'}, gates:[], blockers:[], rc_ready:true, verdict:'rc_freeze_ready_for_ci'};
  }
