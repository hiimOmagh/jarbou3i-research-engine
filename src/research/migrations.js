/* Jarbou3i Research Engine migrations v0.24.0-beta. */
(function(global){
  'use strict';
  const root = global.Jarbou3iResearchModules = global.Jarbou3iResearchModules || {};
  const MIGRATION_VERSION = '0.24.0-beta';
  const TARGET_VERSION = '0.24.0-beta';
  const SUPPORTED_SOURCES = Object.freeze(['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta']);
  ...
  function detectSourceVersion(raw){
    ...
    for(const candidate of candidates){
      ...
      const match = normalized.match(/0\.(1[1-9]|2[0-3])\.0-beta/);
  ...
  function migrationPath(sourceVersion, targetVersion){
    ...
    const order = ['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta'];
