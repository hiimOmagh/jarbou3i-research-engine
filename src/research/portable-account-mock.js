...
(function(){
  ...
  function disconnected(version = '0.15.0-beta'){
    return {
  ...
  function connect({version = '0.15.0-beta', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '0.15.0-beta'} = {}){
  ...
  function status(session, {version = '0.15.0-beta'} = {}){
