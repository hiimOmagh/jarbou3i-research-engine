...
(function(){
  ...
  function disconnected(version = '0.29.0-rc.1'){
    return {
  ...
  function connect({version = '0.29.0-rc.1', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '0.29.0-rc.1'} = {}){
  ...
  function status(session, {version = '0.29.0-rc.1'} = {}){
