/* Jarbou3i Research Engine source-assisted planning contracts v0.13.0-beta. */
(function(global){
  'use strict';
  ...
  const SOURCE_CONNECTORS = {
    ...
    web_search_planned: {
      ...
      status:'planned',
      live_fetching:false,
      description:'Future connector for compliant web search APIs. Planning only in v0.13.'
    },
    github_planned: {
      label:'GitHub',
      status:'planned',
      live_fetching:false,
      description:'Future connector for public repository metadata and release signals. Planning only in v0.13.'
    },
    hn_planned: {
      label:'Hacker News',
      status:'planned',
      live_fetching:false,
      description:'Future connector for HN public-discussion signals. Planning only in v0.13.'
    },
    youtube_planned: {
      label:'YouTube',
      status:'planned',
      live_fetching:false,
      description:'Future connector for video/transcript metadata through compliant APIs. Planning only in v0.13.'
    },
    reddit_planned: {
      label:'Reddit',
      status:'planned',
      live_fetching:false,
      description:'Future connector for public discourse signals through compliant APIs/providers. Planning only in v0.13.'
    },
    polymarket_planned: {
      label:'Polymarket',
      status:'planned',
      live_fetching:false,
      description:'Future connector for market-implied probability signals. Planning only in v0.13.'
    }
  };
  ...
  function sourcePolicy(version = '0.13.0-beta'){
    return {
  ...
  function buildSourceTaskRequest(input){
    ...
    return {
      request_version: input.version || '0.13.0-beta',
      ...
      safety_policy: sourcePolicy(input.version || '0.13.0-beta')
    };
  }
  ...
  function sourceDiagnostics(packet, request, response){
    ...
    const policy = sourcePolicy(packet?.workflow_version || '0.13.0-beta');
  ...
  function runSourceFixtureSuite(version = '0.13.0-beta'){
