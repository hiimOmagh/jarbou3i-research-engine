/* Jarbou3i Research Engine source-assisted planning contracts v0.24.0-beta. */
(function(global){
  'use strict';
  ...
  function sourcePolicy(version = '0.24.0-beta'){
    return {
  ...
  function buildSourceTaskRequest(input){
    ...
    return {
      request_version: input.version || '0.24.0-beta',
      ...
      safety_policy: sourcePolicy(input.version || '0.24.0-beta')
    };
  }
  ...
  function sourceDiagnostics(packet, request, response){
    ...
    const policy = sourcePolicy(packet?.workflow_version || '0.24.0-beta');
  ...
  function runSourceFixtureSuite(version = '0.24.0-beta'){
