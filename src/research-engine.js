/* Jarbou3i Research Engine v0.1.0-alpha — research workflow skeleton. No live AI calls. */
(function(){
  'use strict';

  const STORAGE_KEY = 'jarbou3i.researchEngine.alpha.v0.1';
  ...
  const COPY = {
    en: {
      ...
      researchSubtitle:'Experimental research-to-strategy pipeline. Manual mode remains untouched; this layer builds plan, evidence, mock AI, critique, and Quality Gate v2.',
      alphaBadge:'v0.1.0-alpha · no live AI',
      ...
      modeRecent:'Recent signals',
      modeSourceHeavy:'Source-heavy',
      modeAdversarial:'Adversarial',
      generatePlan:'Generate research plan',
      copyPlanPrompt:'Copy plan prompt',
      clearPlan:'Clear plan',
      noPlan:'No research plan yet.',
      ...
      supports:'Supports IDs',
      contradicts:'Contradicts IDs',
      confidence:'Confidence',
      notes:'Notes',
      addEvidence:'Add evidence',
      loadDemoEvidence:'Load demo evidence',
      exportEvidence:'Export evidence JSON',
      clearEvidence:'Clear evidence',
      matrixEmpty:'Evidence matrix is empty.',
      workflowTitle:'3. Mock AI Workflow',
      workflowSubtitle:'Provider abstraction starts with a mock provider. It creates valid analysis JSON without calling any external API.',
      generateMock:'Generate mock analysis JSON',
      runMockRepair:'Run mock repair',
      runCritique:'Run mock critique',
      copyDeepPrompt:'Copy deep-research prompt',
      qualityTitle:'Quality Gate v2',
      planScore:'Plan',
      evidenceScore:'Evidence',
      causalScore:'Causal links',
      critiqueScore:'Critique',
      readiness:'Readiness',
      statusReady:'Research workflow ready for mock synthesis.',
      statusNeedPlan:'Generate a research plan first.',
      statusNeedEvidence:'Add evidence before synthesis.',
      statusGenerated:'Mock analysis JSON generated and placed in the import box.',
      statusRepaired:'Mock repair produced schema-compatible JSON.',
      statusCritiqued:'Mock critique generated.',
      copied:'Copied.',
      copyFailed:'Copy failed. Use the visible text manually.',
      urlOptional:'https://example.com/source',
      claimPlaceholder:'Observable claim or research finding',
      sourcePlaceholder:'Publication, report, dataset, transcript, or note title',
      supportsPlaceholder:'I1,A1,T1',
      contradictsPlaceholder:'N1,R1',
      notesPlaceholder:'Why this evidence matters / uncertainty / limitations'
    },
    ar: {
      researchTitle:'مختبر سير العمل البحثي',
      researchSubtitle:'طبقة تجريبية تربط البحث بالتحليل الاستراتيجي. النمط اليدوي يبقى كما هو؛ هذه الطبقة تضيف خطة، مصفوفة أدلة، محاكاة AI، نقد، وبوابة جودة v2.',
      alphaBadge:'v0.1.0-alpha · بدون AI مباشر',
      planTitle:'1. خطة البحث',
      planSubtitle:'حوّل الموضوع إلى أسئلة بحث، مصادر مستهدفة، فاعلين، أدلة مضادة، ومؤشرات إنذار مبكر.',
      planMode:'نمط البحث',
      modeStructural:'هيكلي',
      modeRecent:'إشارات حديثة',
      modeSourceHeavy:'مرتكز على المصادر',
      modeAdversarial:'نقدي/خصومي',
      generatePlan:'توليد خطة البحث',
      copyPlanPrompt:'نسخ برومبت الخطة',
      clearPlan:'مسح الخطة',
      noPlan:'لا توجد خطة بحث بعد.',
      ...
      strength:'القوة',
      publicSignal:'الإشارة العامة',
      supports:'يدعم IDs',
      contradicts:'يناقض IDs',
      confidence:'الثقة',
      notes:'ملاحظات',
      addEvidence:'إضافة دليل',
      loadDemoEvidence:'تحميل أدلة تجريبية',
      exportEvidence:'تصدير أدلة JSON',
      clearEvidence:'مسح الأدلة',
      matrixEmpty:'مصفوفة الأدلة فارغة.',
      workflowTitle:'3. سير AI تجريبي',
      workflowSubtitle:'تجريد المزوّد يبدأ بمزوّد وهمي. ينتج JSON صالحًا دون الاتصال بأي API خارجي.',
      generateMock:'توليد JSON تحليلي تجريبي',
      runMockRepair:'تشغيل إصلاح تجريبي',
      runCritique:'تشغيل نقد تجريبي',
      copyDeepPrompt:'نسخ برومبت البحث العميق',
      qualityTitle:'بوابة الجودة v2',
      planScore:'الخطة',
      evidenceScore:'الأدلة',
      causalScore:'الروابط السببية',
      critiqueScore:'النقد',
      readiness:'الجاهزية',
      statusReady:'سير العمل البحثي جاهز للمحاكاة.',
      statusNeedPlan:'ولّد خطة بحث أولًا.',
      statusNeedEvidence:'أضف أدلة قبل التوليف.',
      statusGenerated:'تم توليد JSON تجريبي ووضعه في خانة الاستيراد.',
      statusRepaired:'الإصلاح التجريبي أنتج JSON متوافقًا.',
      statusCritiqued:'تم توليد نقد تجريبي.',
      copied:'تم النسخ.',
      copyFailed:'تعذر النسخ. استخدم النص الظاهر يدويًا.',
      urlOptional:'https://example.com/source',
      claimPlaceholder:'ادعاء قابل للملاحظة أو نتيجة بحثية',
      sourcePlaceholder:'تقرير، دراسة، قاعدة بيانات، تفريغ، أو ملاحظة',
      supportsPlaceholder:'I1,A1,T1',
      contradictsPlaceholder:'N1,R1',
      notesPlaceholder:'لماذا هذا الدليل مهم / عدم اليقين / الحدود'
    },
    fr: {
      researchTitle:'Laboratoire de workflow de recherche',
      researchSubtitle:'Couche expérimentale reliant la recherche à l’analyse stratégique. Le mode manuel reste intact; cette couche ajoute plan, matrice de preuves, IA simulée, critique et barrière qualité v2.',
      alphaBadge:'v0.1.0-alpha · aucune IA active',
      ...
      modeStructural:'Structurel',
      modeRecent:'Signaux récents',
      modeSourceHeavy:'Très sourcé',
      modeAdversarial:'Adversarial',
      generatePlan:'Générer le plan',
      copyPlanPrompt:'Copier le prompt du plan',
      clearPlan:'Effacer le plan',
      noPlan:'Aucun plan de recherche.',
      ...
      claim:'Énoncé',
      sourceTitle:'Titre de source',
      sourceUrl:'URL source',
      sourceType:'Type de source',
      sourceDate:'Date source',
      strength:'Force',
      publicSignal:'Signal public',
      supports:'Soutient IDs',
      contradicts:'Contredit IDs',
      confidence:'Confiance',
      notes:'Notes',
      addEvidence:'Ajouter preuve',
      loadDemoEvidence:'Charger preuves démo',
      exportEvidence:'Exporter preuves JSON',
      clearEvidence:'Effacer preuves',
      matrixEmpty:'La matrice de preuves est vide.',
      workflowTitle:'3. Workflow IA simulé',
      workflowSubtitle:'L’abstraction fournisseur commence par un fournisseur simulé. Il crée un JSON valide sans API externe.',
      generateMock:'Générer JSON simulé',
      runMockRepair:'Réparation simulée',
      runCritique:'Critique simulée',
      copyDeepPrompt:'Copier prompt deep-research',
      qualityTitle:'Barrière qualité v2',
      planScore:'Plan',
      evidenceScore:'Preuves',
      causalScore:'Liens causaux',
      critiqueScore:'Critique',
      readiness:'Préparation',
      statusReady:'Workflow prêt pour synthèse simulée.',
      statusNeedPlan:'Générez d’abord un plan.',
      statusNeedEvidence:'Ajoutez des preuves avant la synthèse.',
      statusGenerated:'JSON simulé généré et placé dans la zone d’import.',
      statusRepaired:'Réparation simulée compatible avec le schéma.',
      statusCritiqued:'Critique simulée générée.',
      copied:'Copié.',
      copyFailed:'Copie impossible. Utilisez le texte visible manuellement.',
      urlOptional:'https://example.com/source',
      claimPlaceholder:'Énoncé observable ou résultat de recherche',
      sourcePlaceholder:'Publication, rapport, données, transcript ou note',
      supportsPlaceholder:'I1,A1,T1',
      contradictsPlaceholder:'N1,R1',
      notesPlaceholder:'Pourquoi cette preuve compte / incertitude / limites'
    }
  };
  ...
  function buildDeepResearchPrompt(){
    ...
    return `You are a deep-research agent feeding Jarbou3i Research Engine.\n\nUse the provided research plan and evidence matrix to produce a source-disciplined strategic analysis.\n\nInput:\n${JSON.stringify(payload, null, 2)}\n\nTask:\n1. Identify missing evidence and source weaknesses.\n2. Cluster related evidence claims.\n3. Separate observation, inference, and estimate.\n4. Produce a Jarbou3i strategic analysis JSON using the sequence Interests → Actors → Tools → Narrative → Results → Feedback.\n5. Include contradictions, scenarios, assumptions, evidence, and falsifiers.\n6. Return JSON only.\n\nDo not claim that sources are verified unless URLs and dates are present.`;
  }

  function makeEvidenceEntry(){
    const entry = {
      evidence_id: `E${state.evidence.length + 1}`,
  ...
  function buildMockAnalysis(){
    ...
    return {
      ...
      subject: {
        title: t,
        context: c,
        question: `How should ${t} be interpreted through the Jarbou3i strategic model?`,
        executive_thesis: `Mock synthesis: ${t} should be treated as an adaptive system where interests, actors, tools, narrative, outcomes, and feedback loops must be tested against evidence rather than accepted as discourse.`
      },
      research_plan: state.plan,
      evidence_matrix: state.evidence,
      interests: [
      ...
      narrative: [
        {id:'N1', name:'Public-interest justification', frame:'security', coherence:4, media_alignment:3, public_acceptance:3, confidence:'medium', rationale:'Mock narrative layer used to test whether stated legitimacy matches tools and outcomes.'}
      ],
      results: [
        {id:'R1', name:'Redistribution of influence', type:'indirect', goal_achieved_pct:55, cost_benefit:3, power_balance_impact:'mixed', confidence:'medium', rationale:'Mock result: power shifts are plausible but require better source confirmation.'}
      ],
      feedback: [
        {id:'F1', description:'Actors adapt tools and narratives after observing public resistance, elite alignment, or institutional friction.', adapts:'tools', speed:'fast', confidence:'medium', rationale:'Feedback loop derived from system dynamics rather than a single-cause explanation.'}
      ],
      causal_links: [
        {from:'I1', to:'A1', relationship:'motivates', evidence_ids:['E1'], confidence:'medium'},
        {from:'A1', to:'T1', relationship:'enables', evidence_ids:['E1','E2'], confidence:'medium'},
        {from:'T1', to:'N1', relationship:'amplifies', evidence_ids:['E2'], confidence:'medium'},
        {from:'R1', to:'F1', relationship:'enables', evidence_ids:['E3'], confidence:'medium'}
      ],
      contradictions: {items:[{
        id:'C1', rhetoric:'Declared public-interest rationale', contradiction_type:'rhetoric_vs_action', affected_layers:['narrative','tools','results'], actions:['Tool selection creates winners and losers beyond the stated goal','Observed outcomes require more evidence before accepting the official explanation'], interpretation:'The contradiction is treated as an information-dense diagnostic point, not as proof of bad faith by itself.', severity:3, confidence:'medium'
      }]},
      scenarios: {items:[{
        id:'S1', name:'Feedback amplification', probability:55, timeframe:'near-to-medium term', drivers:['Narrative synchronization','Tool escalation','Actor realignment'], early_signals:['More coordinated messaging','Legal or institutional acceleration','Visible backlash or counter-mobilization'], disproven_if:['No tool escalation occurs','Opposing actors fail to mobilize','Evidence shows outcomes remain local and non-systemic'], rationale:'Scenario generated for testing the research workflow, not as a final forecast.'
      }]},
      evidence: {items:evidenceAsLegacyItems()},
      assumptions: {items:[{
        id:'AS1', assumption:'The available evidence is representative enough to support a first-pass strategic model.', risk:'high', disproving_test:'Add sources from opposing positions and check whether the causal structure changes.', implication_if_wrong:'The current analysis may overfit a narrow evidence set.'
      }]},
  ...
  function buildCritique(){
    ...
    return {
      critique_version: '0.1.0-alpha',
      generated_at: nowIso(),
      summary: evidenceCount >= 3 ? 'The workflow has enough structure for a mock synthesis, but source verification remains weak.' : 'The workflow is under-evidenced and should not be published.',
      findings: [
        {type:'evidence_gap', severity: urlCount ? 'medium' : 'high', finding: urlCount ? 'Some source URLs are present, but source diversity still needs review.' : 'No source URLs are present; the analysis remains unsupported by verifiable references.'},
        ...
        {type:'causal_risk', severity:'medium', finding:'Causal links are still generated from a small evidence set and should be stress-tested with disconfirming material.'},
  ...
  function qualityScores(){
    ...
    const evidence = Math.min(100, evCount * 18 + state.evidence.filter(e=>e.source_url).length * 10 + state.evidence.filter(e=>e.contradicts?.length).length * 10);
    const causal = state.lastMockAnalysis?.causal_links?.length ? 80 : (evCount >= 2 ? 45 : 0);
    const critique = state.critique ? 85 : 0;
    const readiness = Math.round((plan * 0.25) + (evidence * 0.35) + (causal * 0.2) + (critique * 0.2));
    return {plan, evidence, causal, critique, readiness};
  }
  ...
  function renderPlan(){
    ...
    el.innerHTML = `
      <div class="researchJsonCard">
        <div><b>${esc(state.plan.topic)}</b><span>${esc(state.plan.context)} · ${esc(state.plan.mode)}</span></div>
        <h4>Questions</h4><ul>${state.plan.questions.map(x=>`<li>${esc(x)}</li>`).join('')}</ul>
        <h4>Target sources</h4><div class="miniChips">${state.plan.target_sources.map(x=>`<span>${esc(x)}</span>`).join('')}</div>
        <h4>Early-warning indicators</h4><ul>${state.plan.early_warning_indicators.map(x=>`<li>${esc(x)}</li>`).join('')}</ul>
      </div>`;
  }
  ...
  function renderEvidence(){
    ...
    el.innerHTML = `
      <div class="researchTableWrap"><table class="researchTable">
        <thead><tr><th>ID</th><th>${esc(tr('claim'))}</th><th>${esc(tr('sourceTitle'))}</th><th>${esc(tr('strength'))}</th><th>${esc(tr('supports'))}</th><th>${esc(tr('contradicts'))}</th><th></th></tr></thead>
        <tbody>${state.evidence.map((e,i)=>`<tr>
          ...
          <td>${esc(e.evidence_strength)}/5</td>
          <td>${esc((e.supports || []).join(', ') || '—')}</td>
          <td>${esc((e.contradicts || []).join(', ') || '—')}</td>
          <td><button class="btn ghost researchDelete" type="button" data-index="${i}">×</button></td>
        </tr>`).join('')}</tbody>
      </table></div>`;
    document.querySelectorAll('.researchDelete').forEach(btn => btn.addEventListener('click', () => {
      ...
      state.evidence = state.evidence.map((e,i)=>Object.assign(e,{evidence_id:`E${i+1}`}));
      save(); render();
    }));
  }
  ...
  function renderQuality(){
    ...
    if(!el) return;
    const rows = [
      ['planScore', scores.plan], ['evidenceScore', scores.evidence], ['causalScore', scores.causal], ['critiqueScore', scores.critique], ['readiness', scores.readiness]
    ];
  ...
  function wire(){
    ...
    $('addEvidenceBtn')?.addEventListener('click', () => {
      try { state.evidence.push(makeEvidenceEntry()); save(); clearEvidenceForm(); render(); setStatus(tr('statusReady'), 'good'); }
      catch(_) { setStatus(`${tr('claim')} required.`, 'bad'); }
    });
    $('loadDemoEvidenceBtn')?.addEventListener('click', loadDemoEvidence);
    $('exportEvidenceBtn')?.addEventListener('click', () => downloadJson('jarbou3i-evidence-matrix-alpha.json', {research_plan:state.plan, evidence_matrix:state.evidence}));
    $('clearEvidenceBtn')?.addEventListener('click', () => { state.evidence = []; state.lastMockAnalysis = null; save(); render(); setStatus(tr('statusNeedEvidence'), 'warn'); });
